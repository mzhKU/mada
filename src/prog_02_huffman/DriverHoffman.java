...
public class DriverHoffman {
    ...
    public static void main(String[] args) {
        ...
        occurrence.getOccurrences(inputFile01);

        // 1: Read an ASCII encoded file

        // 2: Generate character counting table

        // 3: Construct Occurrence coding for the counting table

        // 4: Write Occurrence coding table to external file "dec_tab.txt" as
